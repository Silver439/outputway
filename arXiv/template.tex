...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{1\linewidth}
        \centering
        \includegraphics[width=.96\textwidth]{D:/outputway/pictures/Homo_noise_4D/noise4D_M.png}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{.32\linewidth}
        \centering
        \includegraphics[width=1\textwidth]{D:/outputway/pictures/Homo_noise_2D_onlyEI/Fn1_M2D_ins.png}
    \end{subfigure}
    \begin{subfigure}[t]{.32\linewidth}
        \centering
        \includegraphics[width=1\textwidth]{D:/outputway/pictures/Homo_noise_2D_onlyEI/Fn2_M2D_ins.png}
    \end{subfigure}
    \begin{subfigure}[t]{.32\linewidth}
        \centering
        \includegraphics[width=1\textwidth]{D:/outputway/pictures/Homo_noise_2D_onlyEI/Fn7_M2D_ins.png}
    \end{subfigure}
    \begin{subfigure}[t]{.32\linewidth}
        \centering
        \includegraphics[width=1\textwidth]{D:/outputway/pictures/Homo_noise_2D_onlyEI/Fn8_M2D_ins.png}
    \end{subfigure}
    \begin{subfigure}[t]{.32\linewidth}
        \centering
        \includegraphics[width=1\textwidth]{D:/outputway/pictures/Homo_noise_2D_onlyEI/Fn10_M2D_ins.png}
    \end{subfigure}
    \begin{subfigure}[t]{.32\linewidth}
        \centering
        \includegraphics[width=1\textwidth]{D:/outputway/pictures/Homo_noise_2D_onlyEI/Fn13_M2D_ins.png}
    \end{subfigure}
    \begin{subfigure}[t]{.32\linewidth}
        \centering
        \includegraphics[width=1\textwidth]{D:/outputway/pictures/Homo_noise_2D_onlyEI/Fn18_M2D_ins.png}
    \end{subfigure}
    \begin{subfigure}[t]{.32\linewidth}
        \centering
        \includegraphics[width=1\textwidth]{D:/outputway/pictures/Homo_noise_2D_onlyEI/Fn19_M2D_ins.png}
    \end{subfigure}
    \begin{subfigure}[t]{.32\linewidth}
        \centering
        \includegraphics[width=1\textwidth]{D:/outputway/pictures/Homo_noise_2D_onlyEI/Fn22_M2D_ins.png}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{1\linewidth}
        \centering
        \includegraphics[width=.96\textwidth]{D:/outputway/pictures/Non-homo_noise_2D/Non-homo2D_M.png}
    \end{subfigure}
